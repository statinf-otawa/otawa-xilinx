...
xilinx_a9_time_t A9_time_single_ldr            = {1, 3, true};
xilinx_a9_time_t A9_time_single_ldrb_ldrh      = {2, 5, true};
xilinx_a9_time_t A9_time_multiple_ldr          = {0, 3, true}; // the real value of ex_cost and result_latency are respectively : len(Reg)/2 +1 and 3*len(Reg)
xilinx_a9_time_t A9_time_single_str            = {1, 3, true};
xilinx_a9_time_t A9_time_multiple_str          = {0, 3, true}; // the real value of ex_cost and result_latency are respectively : len(Reg)/2 +1 and 3*len(Reg)
xilinx_a9_time_t A9_time_single_strb_strh      = {2, 5, true};
...
xilinx_a9_time_t A9_time_unknown 		       = {15, 15, false, true};
